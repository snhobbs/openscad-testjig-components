...
head_length = 6.6;
head_diameter = upper_shaft_diameter;
total_length = 44;
body_lip_height = 0.8;
body_length = 23.4;
compression = 0;
...
module make_GP_2S(body_lip_diameter = body_lip_diameter,
...
function get_GP_2S_hole_dimensions() = [[body_lip_diameter, body_lip_height], [body_diameter, body_length]];

make_GP_2S(head_length=head_length, total_length=44, body_length=body_length);
